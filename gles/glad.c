/*
    ...
    OpenGL ES loader generated by glad 0.1.36 on Wed Nov 27 02:14:57 2024.
    ...
    Commandline:
        --profile="core" --api="gles2=3.1" --generator="c" --spec="gl" --local-files --extensions=""
    Online:
...
int gladLoadGLES2Loader(GLADloadproc load) {
	...
	if(glGetString == NULL) {
		fprintf(stderr, "Failed to initialize GLAD glGetString\n");
		return 0;
	}
	...
	// if(version == NULL || renderer == NULL || vendor == NULL) {
	// 	fprintf(stderr, "Failed to initialize GLAD glGetString GL_VERSION: %d\n", glGetError());
	// 	return 0;
	// }
	...
	GLVersion.major = 3;
	GLVersion.minor = 1;
	fprintf(stderr, "GLVersion.major=%d GLVersion.major=%d\n", GLVersion.major, GLVersion.minor);
